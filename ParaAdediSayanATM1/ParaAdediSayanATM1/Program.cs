        ...
        static void Main(string[] args)
        {
            ...
            if (x >= 20)
            {
                ...
                if (x >= 20)
                {
                    ...
                    // (3.1)Banknot sayısını bulma aşaması
                    if (x/200!=0)
                    {
                        int bolum1 = x / 200;
                        adet += bolum1;
                    ...
                    // (3.2)Banknot sayısını bulma aşaması
                    if (x/100!=0)
                    {
                        int bolum2 = x / 100;
                        adet += bolum2;
                    ...
                    // (3.3)Banknot sayısını bulma aşaması
                    if (x/50!=0)
                    {
                        int bolum3 = x / 50;
                        adet += bolum3;
                    ...
                    // (3.4)Banknot sayısını bulma aşaması
                    if (x/20!=0)
                    {
                        int bolum4 = x / 20;
                        adet += bolum4;
                    ...
                    // (3.5)Banknot sayısını bulma aşaması
                    if (x/10!=0)
                    {
                        int bolum5 = x / 10;
                        adet += bolum5;
                    ...
                    // (3.6)Banknot sayısını bulma aşaması
                    if (x/5!=0)
                    {
                        int bolum6 = x / 5;
                        adet += bolum6;
